...
- Level 2: Everything in Level 1, plus integration with node.js server for hosting your experiment and writing data to file without a database. See section entitled `Launch your experiment on a web server` below.
- Level 3: Everything in Level 2, plus integration with an already running mongodb server. 
