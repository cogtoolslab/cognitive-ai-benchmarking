  ...
  var familiarization_trials_pre = _.map(
    ...
    function (n, i) {
      return _.extend({}, familiarizationExperimentInstance, n, {
        ...
        stimulus: [n.mp4s_url],
        overlay: [n.maps_url],
        overlay_time: 3 + (0.45 * 0.66), // show the initial image for longer to compensate for the shorter video
        blink_time: 500,
        stop: 0.45/3, //STIM DURATION stop the video after X seconds — set to a third of the normal value to account for scenarios (ie. collision that do require shorter periods of the video being shown)
        width: 500,
        height: 500,
        post_trial_gap: 0,
        on_start: stim_log,
